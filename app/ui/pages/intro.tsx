...
export default function Intro() {
  return (
    <div className="px-4 md:px-8 lg:px-16 relative ">
      ...
      <section className="py-16 px-6 rounded-lg relative z-10">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold mb-4 uppercase tracking-wider text-purple-500">
          {textData.intro.heading}
        </h2>
        <div className="space-y-4 max-w-3xl ">
          {/* Display the first element as normal text */}
          <p className="text-base py-4 md:text-lg lg:text-xl text-justify leading-relaxed text-gray-300 font-semibold">
          ...
          {textData.intro.paragraph.slice(1).map((point, index) => (
            <div key={index} className="flex items-center text-base md:text-md leading-relaxed text-gray-300 ">
