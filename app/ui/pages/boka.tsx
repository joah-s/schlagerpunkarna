                    ...
                    <div className="flex flex-col gap-8 max-w-2xl mx-auto">
                        ...
                        >
                            ...
                            <form className="space-y-4" onSubmit={handleSubmit}>
                                <div>
                                    <label htmlFor="name" className="block text-gray-300 font-Viga mb-4">Namn</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-4 py-4 bg-gray-900/50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors text-white placeholder-gray-400"
                                ...
                                <div>
                                    <label htmlFor="email" className="block text-gray-300 font-Viga mb-4">E-post</label>
                                    <div className="relative">
                                        <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 h-6 w-6" />
                                        <input
                                            type="email"
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-gray-300 font-Viga mb-4">Meddelande</label>
                                    <textarea
                                        id="message"
                                        name="message"
                                        rows={4}
                                        ...
                                        onChange={handleChange}
                                        className="w-full px-4 py-4 bg-gray-900/50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors text-white placeholder-gray-400"
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    type="submit"
                                    className="w-full p-4 rounded-lg font-medium text-white transition-all transform bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 font-Viga flex items-center justify-center gap-4"
                                >
                                    <SendHorizontal className="w-6 h-6" />
